...
FaderMax = 16383 # 14-bit fader resolution
ChannelPanRange = 2.0 # Full sweep of FL Studio's channel pan value (-1.0 left .. 1.0 right), used with channels.getChannelPan() / setChannelPan()

ModeShortDescriptions = ('Pan', 'Stereo', 'Sends', 'EQ', 'Effects', 'Channels')
ModeDescriptions = (
