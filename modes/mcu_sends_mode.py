...
from behaviors.mixer_encoder_sends_behavior import MixerEncoderSendsBehavior
...
class McuSendsMode(McuBaseMode):
    ...
    def __init__(self, device: McuDevice, trackBankingManager: TrackBankingManager):
        ...
        super().__init__(device, [
            screenBehavior,
            ModeButtonsBehavior(device, mcu_buttons.Sends),
            ...
            MixerEncoderSendsBehavior(device, trackBankingManager, screenBehavior),
